...
- Canonical notebook folder: `D:\Documents\Lap trinh\NeuralSpace\notebooks`
- Start script: `scripts/start-jupyter.ps1`
- Registered kernel: `Python (NeuralSpace)`
...
- With explicit Python runtime:
  `powershell -ExecutionPolicy Bypass -File .\scripts\start-jupyter.ps1 -PythonPath "D:\Documents\Lap trinh\NeuralSpace\.venv\Scripts\python.exe"`
...
- In UI: `Kernel` -> `Change Kernel` -> choose `Python (NeuralSpace)`.
