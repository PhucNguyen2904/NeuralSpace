...
const variantClassMap = { primary:"bg-accent text-white hover:bg-accent-hover hover:shadow-glow", secondary:"bg-bg-surface text-text-primary border border-border hover:bg-bg-overlay", danger:"bg-error/90 text-white hover:bg-error", ghost:"bg-transparent text-text-secondary hover:bg-bg-overlay hover:text-text-primary" };
